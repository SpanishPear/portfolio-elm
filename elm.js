...
var $author$project$Post$Title$Title = function (a) {
	return {$: 'Title', a: a};
};
...
var $author$project$Post$Title$urlParser = A2(
	$elm$url$Url$Parser$custom,
	'Title',
	function (str) {
		return $elm$core$Maybe$Just(
			$author$project$Post$Title$Title(str));
	});
...
var $author$project$Components$NavBar$navbar = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('nav-container')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('nav-item-right-container')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('nav-right-item'),
									$elm$html$Html$Attributes$href('/resume')
								]),
							_List_fromArray(
								[
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('about-content-text-container')
						]),
					_List_fromArray(
						[
							A2(
...
var $author$project$Page$Home$Landing$view = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('home-text-container')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('landing-text-subtitle')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Computer Scientist')
						]))
				]))
		]));
var $author$project$Page$Home$Home$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
...
var $author$project$Page$Post$view = function (title) {
	return A2(
		$elm$html$Html$h2,
		_List_Nil,
		_List_fromArray(
		...
		if (_v0.$ === 'Just') {
			...
			switch (route.$) {
				...
				case 'Resume':
					return 'Resume';
				case 'Post':
					var postTitle = route.a;
					return $author$project$Post$Title$toString(postTitle);
				default:
					return '404';
			}
		} else {
